...
export const UpdateSectionPriceButton = forwardRef<HTMLButtonElement, ButtonProps>((props, ref) => {
  ...
  const handleUpdateSection: FormEventHandler = e => {
    ...
    console.log('update-price section')
    handleClose()
  }
    ...
    <>
      ...
      <Modal open={isOpen} onClose={handleClose}>
        <ModalContent
          ...
          gap={3}
        >
          <Typography>Редатировать сечение 150x38x6 для цеха 1</Typography>
